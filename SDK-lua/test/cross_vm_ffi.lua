...
local handler=java.import('com.lockheed.androlua.LuaCallbackDispatcher')
...
local new_state=thread.newState()
local ffi_test=vm.cross_vm_require(new_state,"test.cross_vm_ffi_exec")
ffi_test.throw(params,proxy)
